...
/*   Updated: 2025/04/29 16:54:21 by msokolov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int init_game(t_map *map_data)
{
    ...
    map_data->mlx = mlx_init(map_data->width * T_S, map_data->hight * T_S, "so_long", false);
    texture_load(&text);
...
int main(int argc, char **argv)
{
    ...
    if (argc != 2)
        return (0);
    // map_data.mlx = mlx_init(map_data.width, map_data.hight, "So Long!", false);
    // if (!map_data.mlx)

...
{
	if (map_data->player_y == 0 || map_data->player_x == 0 || map_data->map
		[(map_data->player_y - T_S) / T_S][(map_data->player_x) / T_S] == WALL)
		return ;
	else if ((map_data->map[(map_data->player_y - T_S) / T_S]
			[(map_data->player_x) / T_S] == EXIT)
...
{
	if (map_data->player_y == 0 || map_data->player_x == 0 || map_data->map
		[(map_data->player_y) / T_S][(map_data->player_x - T_S) / T_S] == WALL)
		return ;
	else if ((map_data->map[(map_data->player_y) / T_S]
			[(map_data->player_x - T_S) / T_S] == EXIT)
		&& map_data->colle_count != map_data->collect)
		return ;
